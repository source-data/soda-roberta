...
from transformers.data.data_collator import PaddingStrategy, DataCollatorMixin
...
class DataCollatorForLanguageModelingWithFixedLength(DataCollatorMixin):
    ...
    def torch_call(self, examples: List[Union[List[int], Any, Dict[str, Any]]]) -> Dict[str, Any]:
        ...
        batch = self.tokenizer.pad(examples, return_tensors="pt", padding='max_length', max_length=self.pad_to_fixed_length)
