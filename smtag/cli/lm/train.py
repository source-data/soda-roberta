...
if __name__ == "__main__":
    ...
    parser.add_argument("data_config_name", nargs="?", default="MLM", choices=[
        "MLM", "DET", "VERB", "SMALL", "NOUN", "SEQ2SEQ", "NOLM", "ROLES",
        "GENEPROD_INTERVENTION", "GENEPROD_OBSERVATION", "GENEPROD",
        "QandA", "AandQ", "NEXT", "MULTITASK",
