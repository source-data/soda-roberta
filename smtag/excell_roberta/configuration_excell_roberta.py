...
class EXcellRobertaConfig(PretrainedConfig):
    r"""
    ...
    Args:
        ...
        dense_layer_bias (`bool`, *optional*, defaults to `Falser`):
            Whether or not using bias in the dense layers.
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.swiglu = swiglu
        self.swiglu_reduction = swiglu_reduction
        ...
        self.dense_layer_bias = dense_layer_bias
        self.classifier_dropout = classifier_dropout


class EXcellRobertaOnnxConfig(OnnxConfig):
    @property
